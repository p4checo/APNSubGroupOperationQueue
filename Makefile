...
tvOS:
	set -o pipefail && xcodebuild test -project APNSubGroupOperationQueue.xcodeproj -scheme 'APNSubGroupOperationQueue tvOS' -sdk appletvsimulator -destination "platform=tvOS Simulator,name=Apple TV 4K" | xcpretty
